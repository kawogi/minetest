...
void compressZlib(const String &data, std::ostream &os, int level = -1);
...
void compressZstd(const String &data, std::ostream &os, int level = 0);
void decompressZstd(std::istream &is, std::ostream &os);

// These choose between zlib and a self-made one according to version
void compress(const SharedBuffer<u8> &data, std::ostream &os, u8 version, int level = -1);
void compress(const String &data, std::ostream &os, u8 version, int level = -1);
